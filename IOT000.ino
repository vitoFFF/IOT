...
//Add WIFI data
const char* ssid = "Magti";              //Add your WIFI network name 
const char* password =  "magti123";           //Add WIFI password
...
void loop() {  
  ...
  if(Actual_Millis - Previous_Millis > refresh_time){
    ...
    if(WiFi.status()== WL_CONNECTED){                   //Check WiFi connection status  
      ...
      http.begin("https://winkk.000webhostapp.com/esp32_update.php");   //Indicate the destination webpage 
